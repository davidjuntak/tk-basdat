...
<head>
    ...
    <title>{{ config('app.name') }} | Daftar Sebagai Relawan</title>
...
<div class="register-box">
    ...
    <div class="register-box-body">
        <p class="login-box-msg">Daftar Sebagai Relawan</p>
        ...
        <form action="{{ route('register.submit') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input name="no_hp" type="text" class="form-control" placeholder="No. handphone" required>
                <span class="glyphicon glyphicon-phone-alt form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input name="keahlian" type="text" class="form-control" placeholder="Keahlian yang dimiliki" required>
